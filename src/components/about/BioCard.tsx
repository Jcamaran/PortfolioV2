...
export default function BioCard() {
  ...
  return (
    <motion.div
      ...
      className="md:col-span-2 md:row-span-2 bg-white/5 backdrop-blur-lg border border-white/10 rounded-3xl p-5 lg:p-8 shadow-xl hover:border-purple-300 transition-all duration-300 flex flex-col justify-between overflow-hidden "
    >
