  ...
  return (
    ...
    >
      ...
      <div className="p-3 sm:p-4 flex flex-col grow ">
        {/* Title - Fixed height */}
        <div className="mb-2 sm:mb-3 min-h-6 sm:min-h-8 flex items-start">
          <h3 className="text-base sm:text-lg font-bold text-white group-hover:text-purple-300 transition-colors duration-300 line-clamp-2">
            {title}
          </h3>
        </div>
            ...
            <>
              {github && (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-1.5 sm:gap-2 py-1.5 sm:py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg sm:rounded-xl transition-all border border-white/20 hover:border-white/40 group/btn"
                >
